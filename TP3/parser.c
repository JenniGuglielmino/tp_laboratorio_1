...
int parser_EmployeeFromText(FILE* pFile , LinkedList* pArrayListEmployee)
{
    ...
    do{
        ...
        auxEmp = nuevoEmpleadoParam(id, nombre, horas, sueldo);
            if(auxEmp != NULL)
            {
...
int parser_EmployeeFromBinary(FILE* pFile , LinkedList* pArrayListEmployee)
{
    ...
    if(pFile != NULL && pArrayListEmployee != NULL)
    {
        while(!feof(pFile))
        {
            ...
            {
                auxiliar = nuevoEmpleadoParam(auxiliarEmp.id, auxiliarEmp.nombre, auxiliarEmp.horasTrabajadas, auxiliarEmp.sueldo);
